...
* Fixed an issue where the `[Regions]` section's `Limit` has been broken since its introduction in [Version 1.15](/lucasmodlauncher/versions/version_1.15.md#hacks_custom-limits) on September 20th, 2016.
